...
// Note: isValid() tests require database connection due to date casting, tested via integration tests
...
it('proportional discount distribution works correctly', function () {
    ...
    $totalDiscount = 3000.0; // Use float for consistent calculation
