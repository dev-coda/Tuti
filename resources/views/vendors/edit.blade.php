    ...
    <div class="col-span-2">
            ...
            <div class="p-4 mb-4 bg-white border border-gray-200 rounded-lg shadow-sm 2xl:col-span-2 ">
                ...
                <div class="grid grid-cols-6 gap-6">
                    ...
                    {{ Aire::number('minimum_discount_amount', "Mínimo para descuento")->placeholder('Monto mínimo para aplicar descuento')->helpText('Monto mínimo en productos de este vendor para aplicar el descuento')->groupClass('col-span-3') }}
                    {{  Aire::input('discount', 'Descuento %')->id('discount')->min(0)->max(100)->step(1)->groupClass('col-span-3')}}
