...
<section class="w-full grid grid-cols-12 xl:gap-x-10 gap-x-0 xl:gap-y-0 gap-y-10">
    ...
    <div class="xl:col-span-12 col-span-12 bg-neutral-200 p-6">
        ...
        <div class="grid grid-cols-12 grid-flow-row xl:grid-cols-12 gap-5 ">
            ...
            <div class="border border-gray-100 rounded col-span-4 bg-cover bg-center hover:scale-110 transition duration-500 cursor-pointer object-cover" style="background-image: url({{asset('storage/'.$category->image)}});">
...
<div class="xl:col-span-12 col-span-12 mt-6 mb-0 pb-0">
