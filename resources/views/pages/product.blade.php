...
<div class="grid grid-cols-12 w-full gap-y-5 gap-x-5 max-w-[90vw] mx-auto mt-5">
    ...
    <form action="{{ route('cart.add', $product->id) }}" method="POST" class="xl:col-span-6 col-span-12 space-y-4">
        ...
        <div>
            ...
            <button type="submit" data-add-to-cart data-product-id="{{ $product->id }}" class="bg-secondary p-2 mt-4 text-white hover:bg-gray2 flex px-4 text-xl font-semibold rounded-full items-center justify-center w-52">
                <span>¡Lo quiero! </span>
