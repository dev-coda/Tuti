    ...
    <form action="{{ route('cart.add', $product->id) }}" method="POST" class="xl:col-span-6 col-span-12 space-y-4">
        ...
        <div>
            ...
            <button type="submit" 
                    ...
                    class="bg-secondary p-2 mt-4 text-white hover:bg-gray2 flex px-4 text-xl font-semibold rounded-full items-center justify-start w-52 disabled:opacity-50 disabled:cursor-not-allowed">
                <span>¡Lo quiero! </span>
            ...
            @if($isVacationMode)
                <p class="text-xs text-gray-600 text-left mt-2 w-52 break-words">
