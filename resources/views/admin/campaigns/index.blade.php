                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="flex items-start space-x-3">
                            ...
                            <div class="flex-1">
                                <span class="text-sm font-medium text-gray-900">Etiqueta de descuento</span>
                                <p class="text-xs text-gray-500 mt-1">Muestra en la tarjeta el descuento aplicado (p. ej. -15% o -$2.000), no solo la palabra DESCUENTO</p>
                            </div>
                        </div>
                    </div>
                </div>
