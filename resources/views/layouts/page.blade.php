    ...
    <nav class="bg-slate-700 border-gray-200 border-b  ">
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto py-1 xl:px-0 px-5">
            ...
            <div class="flex items-center space-x-4 flex-row-reverse md:flex-row">
                ...
                <button id='openMobileMenu' class="text-white flex ">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-8 h-8">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M3.75 5.25h16.5m-16.5 4.5h16.5m-16.5 4.5h16.5m-16.5 4.5h16.5" />
                ...
                @auth
                 ...
                 @else
                    ...
                    <a class=" text-white flex items-center space-x-2" href="{{route('register')}}">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 576 512" stroke-width="1" stroke="currentColor" class="w-8 h-8 fill-white"><path stroke-linecap="round" stroke-linejoin="round" d="M512 80c8.8 0 16 7.2 16 16l0 320c0 8.8-7.2 16-16 16L64 432c-8.8 0-16-7.2-16-16L48 96c0-8.8 7.2-16 16-16l448 0zM64 32C28.7 32 0 60.7 0 96L0 416c0 35.3 28.7 64 64 64l448 0c35.3 0 64-28.7 64-64l0-320c0-35.3-28.7-64-64-64L64 32zM208 256a64 64 0 1 0 0-128 64 64 0 1 0 0 128zm-32 32c-44.2 0-80 35.8-80 80c0 8.8 7.2 16 16 16l192 0c8.8 0 16-7.2 16-16c0-44.2-35.8-80-80-80l-64 0zM376 144c-13.3 0-24 10.7-24 24s10.7 24 24 24l80 0c13.3 0 24-10.7 24-24s-10.7-24-24-24l-80 0zm0 96c-13.3 0-24 10.7-24 24s10.7 24 24 24l80 0c13.3 0 24-10.7 24-24s-10.7-24-24-24l-80 0z"/></svg>
                     ...
                     <a class=" text-white flex items-center space-x-2" href="{{route('login')}}">
                       ...
                       <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 448 512" stroke-width="1" stroke="currentColor" class="w-8 h-8 fill-white p-1"><path stroke-linecap="round" stroke-linejoin="round" d="M224 256A128 128 0 1 0 224 0a128 128 0 1 0 0 256zm-45.7 48C79.8 304 0 383.8 0 482.3C0 498.7 13.3 512 29.7 512l388.6 0c16.4 0 29.7-13.3 29.7-29.7C448 383.8 368.2 304 269.7 304l-91.4 0z"/></svg>
