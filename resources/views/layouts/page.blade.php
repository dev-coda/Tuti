        ...
        <nav class="bg-slate-700 border-gray-200 border-b  ">
            <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto py-1 xl:px-0 px-5">
                ...
                <div class="justify-end space-x-2 xl:flex hidden">
                    ...
                    @endif
                    <a class="text-white flex items-center space-x-2" href="{{route('clients.orders.index')}}{{ auth()->user()->hasRole('supervisor') ? '?tab=mis-rutas' : '' }}" title="Mi Cuenta" aria-label="Mi Cuenta">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-8 h-8">
                    ...
                    <a class="text-white flex items-center space-x-2" href="{{ route('contacts.index') }}" title="Interesados">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-8 h-8">
                ...
                <div class="justify-end space-x-2 xl:hidden flex">
                    ...
                    <a class=" text-white flex items-center space-x-2" href="{{route('form')}}">
