        ...
        <div class="">
            <div class="bg-gray-100">
                <div class="p-5 leading-4">
                    <h2 class="text-secondary">Tendero Tronex</h2>
                    <small class="text-gray-500">ID 000000000</small>
                </div>
            </div>
            <ul class="px-5 py-6 space-y-4">
                <li>
                    <a class="flex items-center space-x-2" href="{{route('shoppers.home')}}">
                        <span class="icon-home text-blue1"></span>
                        <span class="text-gray-400">Inicio</span>
                    </a>
                </li>
                <li>
                    <a class="flex items-center space-x-2" href="{{route('shoppers.orders')}}">
                ...
                <li>
                    <a class="flex items-center space-x-2" href="{{route('shoppers.reports')}}">
                        <span class="icon-pie-chart text-blue1"></span>
                        <span class="text-gray-400">Reporte de Ventas</span>
                    </a>
                </li>

                <li>
                    <a class="flex items-center space-x-2" href="{{route('shoppers.contact')}}">
