        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 text-gray-900">
                <div class="flex items-center justify-between mb-6">
                    <div>
                        <h1 class="text-2xl font-bold text-gray-900">Crear Promoción</h1>
                        <p class="text-gray-600">Configura una nueva promoción avanzada con reglas personalizadas</p>
                    </div>
                ...
                <form action="{{ route('promocion.store') }}" method="POST" class="space-y-6">
                    @csrf
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <select name="level" id="level" required
                                class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                                <option value="products" {{ old('level') == 'products' ? 'selected' : '' }}>Productos Específicos</option>
                                <option value="categories" {{ old('level') == 'categories' ? 'selected' : '' }}>Categorías</option>
                                <option value="brands" {{ old('level') == 'brands' ? 'selected' : '' }}>Marcas</option>
                                <option value="vendors" {{ old('level') == 'vendors' ? 'selected' : '' }}>Proveedores</option>
                                <option value="zones" {{ old('level') == 'zones' ? 'selected' : '' }}>Zonas</option>
                            </select>
                            @error('level')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        ...
                        <div id="level_ids_section" class="hidden">
                            ...
                            <input type="hidden" name="level_ids" id="level_ids_input" value="">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <input type="number" name="minimum_cart_value" id="minimum_cart_value" value="{{ old('minimum_cart_value') }}" 
                                    step="0.01" min="0"
                                    class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                            ...
                            <div>
                                ...
                                <input type="number" name="minimum_cart_units" id="minimum_cart_units" value="{{ old('minimum_cart_units') }}" 
                                    min="1"
                                    class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
