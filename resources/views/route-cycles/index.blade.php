...
<div class="p-4 bg-white block sm:flex items-center justify-between border-b border-gray-200">
    <div class="w-full mb-1">
        <div class="mb-4">
            <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl">Ciclos de Rutas</h1>
        </div>
        <div class="items-center justify-between block sm:flex md:divide-x md:divide-gray-100">
            ...
            <div class="flex flex-wrap gap-2 mt-4 sm:mt-0">
                <a href="{{ route('route-cycles.create') }}"
            ...
            <div class="overflow-hidden shadow">
                <table class="min-w-full divide-y divide-gray-200 table-fixed">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        @foreach ($routeCycles as $routeCycle)
                        <tr class="hover:bg-gray-100">
                            ...
                            <td class="p-4 text-base font-medium text-gray-900 whitespace-nowrap">
                                <span class="px-2 py-1 text-xs font-semibold rounded-full 
                                    @if($routeCycle->cycle == 'A') bg-blue-100 text-blue-800
                                    @elseif($routeCycle->cycle == 'B') bg-green-100 text-green-800
                                    @else bg-purple-100 text-purple-800
                                    @endif">
                                    Ciclo {{ $routeCycle->cycle }}
                                </span>
                            </td>
                            <td class="p-4 space-x-2 whitespace-nowrap text-end">
                                <a href="{{ route('route-cycles.edit', $routeCycle) }}"
                                ...
                                {{ Aire::open()->route('route-cycles.destroy', $routeCycle) }}
