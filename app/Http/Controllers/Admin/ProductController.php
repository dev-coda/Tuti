...
class ProductController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $validate = $request->validate([
            ...
            'exclude_from_brand_discount' => 'nullable|boolean',
            'exclude_from_vendor_discount' => 'nullable|boolean',
            'coordinadora_weight_kg' => 'nullable|numeric|min:0',
            'coordinadora_height_cm' => 'nullable|numeric|min:0',
            'coordinadora_width_cm' => 'nullable|numeric|min:0',
            'coordinadora_length_cm' => 'nullable|numeric|min:0',
