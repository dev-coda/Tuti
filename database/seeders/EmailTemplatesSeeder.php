...
class EmailTemplatesSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $templates = [
            ...
            // Client registration invite (set password + start ordering)
            [
                ...
                'type' => EmailTemplate::TYPE_USER_REGISTRATION,
                'body' => $this->getClientRegistrationInviteBody(),
    ...
    private function getClientRegistrationInviteBody()
    {
        return '<h2>Hemos recibido tu información de registro en TUTI</h2>
        <p>Hola {customer_name},</p>
